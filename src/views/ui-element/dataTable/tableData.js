...
const DataTableWithButtons = ({data}) => {
  ...
  const Previous = () => {
    return (
      <Fragment>
        <span className='align-middle d-none d-md-inline-block'>{t('Prec')}</span>
      </Fragment>
    )
  }
  ...
  const Next = () => {
    return (
      <Fragment>
        <span className='align-middle d-none d-md-inline-block'>{t('Suiv')}</span>
      </Fragment>
    )
  }
  ...
  return (
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Liste des lignes d'Opérations</CardTitle>
      </CardHeader>
      ...
      <CardFooter>
        <CardText className='mb-0'>
          <span className='fw-bold'>Note:</span> <span>Ligne opération Data Table</span>
        </CardText>
      </CardFooter>
    </Card>
  )
